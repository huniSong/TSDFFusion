...
//
//    configFile = "E:/TSDF-CUDA-master/config/fusion_config.yaml";
//    dataPath = "E:/TSDF-CUDA-master/data/rgbd-frames/";
//    std::cout << "Data Path : " << dataPath << std::endl;
//    std::cout << "ConfigPath: " << configFile << std::endl;
//
//    CUDATSDFIntegrator *Fusion = new CUDATSDFIntegrator(configFile);
//
...
//
//    float* depth = (float*)malloc(sizeof(float) * 640 * 480);
//    float pose[4 * 4] = { 0 };
...
//        // Read current frame
//        cv::Mat depth_im = cv::imread(depth_im_file, IMREAD_UNCHANGED);
//        cv::Mat color_im = cv::imread(color_im_file);
//        //std::cout << "Channels: " << color_im.channels() << std::endl;
//        cv::cvtColor(color_im, color_im, COLOR_BGR2RGBA);
